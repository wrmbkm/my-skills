...
| ConnectX-8 Firmware | v40.48.1000（GA）/ v40.47.2682（LTS）| GA / LTS U2 | 2026-02 / 2026-03-23 |

> 2026-05-15 复核：NCCL、CUDA、DOCA-OFED、MFT 未发现高于上述记录的新版本；ConnectX-8 Firmware 的 LTS 记录按官方 release notes 修正为 v40.47.2682（2025 LTS U2）。

## 版本选择说明
- ConnectX-8 Firmware 长期维护双分支并行：
  - **v40.48.1000**：新功能分支，2026 年 2 月 MFT v4.35.0 GA 捆绑，Spectrum-X 2.1 验证通过，Gen6+GPU 混合部署必须用
  - **v40.47.2682**：LTS 安全补丁分支，官方文档标记为 **2025 LTS U2**，发布时间/页面更新时间为 2026-03-23；本地旧记录中的 **v40.47.1088 / LTS U5** 标注与官方 release notes 不一致，现以官方记录为准
